...
<html>
<head>
<title>게 시 판(Struts2+Spring2.5+Ajax)</title>
...
<div id="bbsList">
	...
	<div id="bbsList_header">
		...
		<div id="rightHeader">
			...
			onclick="javascript:location.href='<%=cp%>/ibbs/created.action'"/>
		</div>
	</div>
	<div id="bbsList_list">
		<div id="title">
		...
		<div id="lists">
			...
			<dl>
				...
				<dd class="subject">
				<a href="javascript:location.href='${urlArticle }&boardNum=${dto.boardNum }'">
				${dto.subject }
				</a>
				</dd>
